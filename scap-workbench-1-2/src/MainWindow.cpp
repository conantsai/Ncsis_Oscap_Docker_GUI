...
# endif
    ...
    QObject::connect(
        mUI.actionDocker_Image_Scan, SIGNAL(triggered()),
        this, SLOT(imagescanQt())
    );

    QObject::connect(
        mUI.actionDocker_Container_Scan, SIGNAL(triggered()),
        this, SLOT(containerscanQt())
    );
}
...
void MainWindow::imagescanQt()
{
    imagescan = new DockerImageScan;
    imagescan->show();
}

void MainWindow::containerscanQt()
{
